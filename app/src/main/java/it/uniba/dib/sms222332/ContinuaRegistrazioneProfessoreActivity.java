...
public class ContinuaRegistrazioneProfessoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Dichiaro il menu a tendina per il ruolo
        Spinner spinner = findViewById(R.id.spinnerRuolo);
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.ruolo_array, android.R.layout.simple_spinner_item);
        ...
        buttonConcludiRegistrazione.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(ContinuaRegistrazioneProfessoreActivity.this, "Registrazione conclusa con successo!", Toast.LENGTH_SHORT).show();
                Intent intentLogin = new Intent(ContinuaRegistrazioneProfessoreActivity.this, LoginActivity.class);
